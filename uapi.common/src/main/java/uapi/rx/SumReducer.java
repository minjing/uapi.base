...
public class SumReducer<T> extends Reducer<T> {
    ...
    public T getItem() throws NoItemException {
        ...
        switch (this._type) {
            case INT:
                return (T) Integer.valueOf(this._sum.intValue());
            case FLOAT:
                return (T) Float.valueOf(this._sum.floatValue());
            case DOUBLE:
                return (T) Double.valueOf(this._sum.doubleValue());
            case LONG:
                return (T) Long.valueOf(this._sum.longValue());
            default:
